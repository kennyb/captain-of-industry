...
- (optional) go looking out on the map for the cement for coal import and see if I can't import coal instead and burn the FG to make cement (I'm really trying to reduce coal usage).
